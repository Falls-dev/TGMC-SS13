...
[span_admin("<span class='message'>[ADMIN_FULLMONTY(M)]")]</span><hr></span>"})
	...
	if(href_list["deny"])
		...
		priority_announce("Сигнал бедствия заблокирован. Пусковые трубы перекалибруются.", "Сигнал Бедствия", sound = 'modular_unga/ru_translate/ru_announce/sound/distressbeaconlocked.ogg')
