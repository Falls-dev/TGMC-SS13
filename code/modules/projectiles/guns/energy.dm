...
/obj/item/weapon/gun/energy/beam_cannon
	...
	desc = "A heavy and powerful weapon that fires an intense laser. Can overheat if fired too quickly."
	icon = 'icons/obj/items/guns/energy64-ported.dmi'
...
/obj/item/weapon/gun/energy/beam_cannon/proc/autonomous_pre_fire()
	...
	var/obj/machinery/deployable/mounted/sentry/sentry = loc
...
///Works similar to beam() but can be stopped by dense and opaque turfs
...
/obj/item/weapon/gun/energy/beam_cannon/unlimited
	gun_features_flags = GUN_ENERGY|GUN_NO_PITCH_SHIFT_NEAR_EMPTY|GUN_WIELDED_STABLE_FIRING_ONLY
	rounds_per_shot = 0
	heat_per_fire = 0
