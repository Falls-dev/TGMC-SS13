...
/datum/sprite_accessory
	...
	var/list/species_allowed = list("Human","Human Hero", "Synthetic", "Engineer Synthetics", "Medical Synthetic", "Vat-Grown", "Vatborn") // Restrict some styles to specific species
