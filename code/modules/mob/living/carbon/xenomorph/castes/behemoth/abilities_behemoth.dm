...
#define LANDSLIDE_DAMAGE_LIVING_MULTIPLIER 1.3 // percent
#define LANDSLIDE_KNOCKDOWN_DURATION 2 SECONDS
...
#define GEOCRUSH_LIVING_DAMAGE_MULTIPLIER 1.3
