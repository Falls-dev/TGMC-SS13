...
/mob/living/silicon/ai/verb/make_announcement()
	...
	priority_announce(input, "Оповещение от [src]", sound = 'modular_unga/ru_translate/ru_announce/sound/aireport.ogg')
...
/mob/living/silicon/ai/verb/shutdown_systems()
	...
	priority_announce("[src] был отключен. Ожидание загрузки новой личности...", "Сбой ИИ", sound = 'modular_unga/ru_translate/ru_announce/sound/aileft.ogg')
	ghostize(FALSE)
	offer_mob()
