...
/datum/round_event/stock_uptick/start()
	...
	priority_announce("В связи с ростом квартальной выручки Nanotrasen наш объем поставок увеличился на [points_to_be_added] очков.", sound = 'modular_unga/ru_translate/ru_announce/sound/supply_increase.ogg')
