...
/proc/power_failure(announce = TRUE)
	...
	if(announce)
		priority_announce("В системе питания судна обнаружена аномальная активность. В качестве меры предосторожности питание будет отключено на неопределенный срок.", "Критический Сбой Питания", sound = 'modular_unga/ru_translate/ru_announce/sound/poweroff.ogg')
...
/proc/power_restore(announce = TRUE)
	...
	if(announce)
		priority_announce("Питание восстановлено. Причина: Неизвестно.", "Восстановление Питания", sound = 'modular_unga/ru_translate/ru_announce/sound/poweron.ogg')
