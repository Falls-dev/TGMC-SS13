...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(6)
			return list(ACCESS_MARINE_PREP, ACCESS_MARINE_MEDPREP, ACCESS_MARINE_ENGPREP, ACCESS_MARINE_SMARTPREP, ACCESS_MARINE_SPECPREP, ACCESS_MARINE_LEADER,)//spess mahreens
		if(7)
