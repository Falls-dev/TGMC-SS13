...
/datum/scanner_advice/traumatic_shock/can_show(mob/living/carbon/human/patient, mob/user)
	if(patient.painloss > 50 && !patient.reagents.has_reagent(/datum/reagent/medicine/paracetamol) && !patient.reagents.has_reagent(/datum/reagent/medicalnanites) && !patient.reagents.has_reagent(/datum/reagent/medicine/tramadol) && !patient.reagents.has_reagent(/datum/reagent/medicine/sulfasalazine))
		return TRUE
