/datum/game_mode/infestation/distress
	...
	silo_scaling = 2
	round_type_flags = MODE_INFESTATION|MODE_LATE_OPENING_SHUTTER_TIMER|MODE_XENO_RULER|MODE_PSY_POINTS|MODE_PSY_POINTS_ADVANCED|MODE_HIJACK_POSSIBLE|MODE_SILO_RESPAWN|MODE_SILOS_SPAWN_MINIONS|MODE_ALLOW_XENO_QUICKBUILD
...
/datum/game_mode/infestation/distress/post_setup()
	. = ..()
	SSpoints.add_strategic_psy_points(XENO_HIVE_NORMAL, 2 * RESIN_SILO_PRICE)
	SSpoints.add_tactical_psy_points(XENO_HIVE_NORMAL, 4 * XENO_RESIN_TURRET_PRICE)
