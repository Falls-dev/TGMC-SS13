/obj/machinery/vending/weapon
	...
	products = list(
		...
		"Гранаты" = list(
			...
			/obj/item/ammo_magazine/rifle/tx54/smoke/antigas = 2,
...
/obj/machinery/vending/weapon/valhalla
	...
	products = list(
		...
		"Гранаты" = list(
			...
			/obj/item/ammo_magazine/rifle/tx54/incendiary/G = -1,
			/obj/item/ammo_magazine/rifle/tx54/incendiary/X = -1,
			...
			/obj/item/ammo_magazine/rifle/tx54/smoke/antigas = 2,
			/obj/item/ammo_magazine/rifle/tx54/healing_foam = -1,
