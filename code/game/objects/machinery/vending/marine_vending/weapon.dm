/obj/machinery/vending/weapon
	...
	products = list(
		...
		"Коробки" = list(
			...
			/obj/item/matter_ammo_container/box = -1,
			/obj/item/matter_ammo_container/box/packet = -1,
			...
			/obj/item/storage/box/visual/magazine/matter_ammo/full_box = -1,
			/obj/item/storage/box/visual/magazine/matter_ammo/full_packets = -1,
