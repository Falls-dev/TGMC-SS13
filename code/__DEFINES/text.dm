...
#define MAPTEXT_HUDMESSAGE_TITLE(text, alignment) {"<span style='font-family: \"OCR A Becker RUS-LAT\"; font-size: 12pt; line-height: 1.25; text-align: [##alignment]'><u>[##text]</u></span>"}

#define MAPTEXT_HUDMESSAGE(text, alignment) {"<span style='font-family: \"OCR A Becker RUS-LAT\"; font-size: 10pt; line-height: 1; text-align: [##alignment]; -dm-text-outline: 1px black'>[##text]</span>"}
