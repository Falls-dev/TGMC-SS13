...
////////////////////RU TGMC EDIT START////////////////////
//////////////////////////////////////////////////////////
#define XENODEATHTIME_CHECK(M) ((world.time - (GLOB.key_to_time_of_role_death[M.key] ? GLOB.key_to_time_of_role_death[M.key] : -INFINITY) < SSticker.mode?.xenorespawn_time))
#define XENODEATHTIME_MESSAGE(M) to_chat(M, span_warning("You have been dead for [(world.time - GLOB.key_to_time_of_role_death[M.key]) * 0.1] second\s.</span><br><span class ='warning'>You must wait [SSticker.mode?.xenorespawn_time * 0.1] seconds before rejoining the game as a Xenomorph! You can take a SSD minion without resetting your timer."))
//////////////////////////////////////////////////////////
/////////////////////RU TGMC EDIT END/////////////////////
//////////////////////////////////////////////////////////
