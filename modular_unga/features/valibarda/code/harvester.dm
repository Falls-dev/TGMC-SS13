...
/obj/item/weapon/twohanded/glaive/halberd/harvester
	...
	icon = 'modular_unga/icons/vali.dmi'
	icon_state = "VAL-HAL-A"
	item_state = "VAL-HAL-A"
	item_icons = list(
		slot_back_str = 'modular_unga/icons/back.dmi',
		slot_l_hand_str = 'modular_unga/icons/vali_left.dmi',
		slot_r_hand_str = 'modular_unga/icons/vali_right.dmi',
	)
	force = 40
