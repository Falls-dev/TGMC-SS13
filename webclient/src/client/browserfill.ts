...
function forwardKey(e: KeyboardEvent, kind: "keydown" | "keyup") {
...
window.addEventListener("keydown", (e) => forwardKey(e, "keydown"));
window.addEventListener("keyup", (e) => forwardKey(e, "keyup"));
